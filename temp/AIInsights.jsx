...
// Four named exports used in DashboardPage:
//   <AIInsights />           – AI recommendations cards row
//   <RecentActivity />       – activity feed panel
//   <ClassLeaderboard />     – leaderboard panel
//   <MonthlyScoreChart />    – grouped bar chart panel
// Default export: AIInsights
...
export function AIInsights() {
  return (
    <div className="bg-white rounded-[18px] border border-[#D0E3F0] overflow-hidden shadow-[0_2px_8px_rgba(10,25,49,0.07)]">
      {/* Header */}
