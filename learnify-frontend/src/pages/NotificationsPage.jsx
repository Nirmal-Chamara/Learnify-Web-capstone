...
const initialNotifications = [
  ...
  },
  {
    ...
    message: "Your weekly timetable has been auto-generated successfully",
    time: "3 hrs ago",
    date: "Today",
    read: true,
  },
  ...
  },
  {
    ...
    type: "resource",
    title: "New Resource Uploaded",
    message: "Ms. Wijesinghe uploaded Essay Writing Techniques notes",
    time: "Yesterday",
    date: "Yesterday",
    read: true,
  },
  {
    ...
    message: "You completed Chemistry — Organic Lab session",
    time: "Yesterday",
    date: "Yesterday",
    read: true,
  },
        ...
        {unreadCount > 0 && (
          <button
            ...
            className="flex items-center gap-2 bg-white border
              border-gray-200 text-[#1A3D63] font-body text-sm
        ...
        {filterTabs.map((tab) => (
          ...
          >
            ...
            {tab === "Unread" && unreadCount > 0 && (
              <span className={`ml-1.5 text-[10px] font-bold px-1.5
                py-0.5 rounded-full
                ${activeFilter === tab
